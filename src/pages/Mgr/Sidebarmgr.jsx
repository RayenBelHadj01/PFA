  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Mgrhom')}>
            <ListItemButton
              sx={{
                minHeight: 48,
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Mgrpj')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Mgrtask')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
